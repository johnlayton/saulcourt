...
class Demo(object):
  ...
  def run(self):
    try:
      ...
      # self.run_func("reverse right", r, r.rgt.reverse, r.rgt.stop, 5);
      # self.run_func("forward right", r, r.rgt.forward, r.rgt.stop, 5);
      #
      # self.run_func("reverse left", r, r.lft.reverse, r.lft.stop, 5);
      # self.run_func("forward left", r, r.lft.forward, r.lft.stop, 5);

      self.run_func("reverse both", r, r.reverse, r.stop, 10);
      self.run_func("forward both", r, r.forward, r.stop, 10);
